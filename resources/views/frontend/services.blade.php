...
<section class="container wrapper m-100">
    <div class="row align-items-end">
        <div class="col-md-6">
            <h3 class="NewKansas-medium">It is all about the customer expirience</h3>
            <p>We are committed to delivering an exceptional customer experience, offering a wide range of trendy and
                ...
                We take pride in our commitment to timely delivery, ensuring you can enjoy your home’s fresh new look
                without any delays.
            </p>
        </div>
        <div class="col-md-6">
            <img src="images/about-section-right-2.svg" alt="" class="img-fluid">
        </div>
    </div>
</section>
...
<section class="bg-white wrapper">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="/frontend/images/sec-img.png" alt="" class="img-fluid">
            </div>
            <div class="col-md-6">
                <!-- <h3 class="NewKansas-medium">We are here to help</h3> -->
                <h4 class="m-para">Our stitching facility offers skilled craftsmanship, precision and customization to create
                    high-quality, tailor-made curtains ensuring the final product meets the exact specifications of the
                    client.
                </h4>
                <h4 class="m-para">Our capacity to work with different types of fabrics, including delicate materials, heavy-duty
                        ...
                        <div class="service-card-carousel owl-carousel owl-theme">
                            <div class="item">
                                <div class="card product-card"
                                    ...
                                    <img src="frontend/images/curtains1.png" alt="">
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/curtains2.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/curtains3.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/curtains4.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                    ...
                    <div class="row" style="margin-top: 42px;">
                        <div class="service-card-carousel owl-carousel owl-theme">
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/blind1.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Sheers</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/blind2.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Sheer Blind</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/blind3.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Roman Blind</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/blind4.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Roman Blind</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/blind5.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"
                    ...
                    <div class="row" style="margin-top: 42px;">
                        <div class="col-md-4">
                            <div class="card product-card"
                                style="height:auto !important; min-height:fit-content !important;">
                                <img src="frontend/images/accessories1.png" alt="">
                                <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                    <h5>Curtain Hooks</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card product-card"
                                style="height:auto !important; min-height:fit-content !important;">
                                <img src="frontend/images/accessories2.png" alt="">
                                <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                    <h5>Curtain Hooks</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card product-card"
                                style="height:auto !important; min-height:fit-content !important;">
                                <img src="frontend/images/accessories3.png" alt="">
                                <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                    ...
                    <div class="row" style="margin-top: 42px;">
                        <div class="service-card-carousel owl-carousel owl-theme">
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/handware1.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Ripple Track</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/handware2.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Flat Track</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/handware3.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>M Track</h5>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="card product-card"
                                    style="height:auto !important; min-height:fit-content !important;">
                                    <img src="frontend/images/handware4.png" alt="">
                                    <div class="card-body p-0 pt-3 text-center NewKansas-medium">
                                        <h5>Curtain Rods</h5>
                                    </div>
                                </div>

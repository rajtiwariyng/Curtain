...
<head>
 ...
 <link href="https://fonts.googleapis.com/css?family=Fira+Sans:ital,wght@0,400" rel="stylesheet" />
 <title>CAB</title>
 <!--[if !mso]><!-- -->
 <style>
 /* cyrillic-ext */
 ...
 .pc-w620-padding-0-0-0-97 {padding: 0px 0px 0px 97px !important;}
 .pc-w620-fontSize-21px {font-size: 21px !important;}
 .pc-w620-lineHeight-16 {line-height: 16px !important;}
 .pc-w620-fontSize-9px {font-size: 9px !important;}
 ...
 .pc-w620-padding-30-30-36-30 {padding: 30px 30px 36px 30px !important;}
 ...
 .pc-w620-itemsSpacings-2-0 {padding-left: 1px !important;padding-right: 1px !important;padding-top: 0px !important;padding-bottom: 0px !important;}
           ...
           <tr>
            <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <!--[if !gte mso 9]><!-- -->
               <td valign="top" class="pc-w620-padding-0-0-15-0" style="background-image: url('https://curtainsandblinds.in/public/images/emails/image-1732469272892.png'); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 0px 0px 36px 47px; border-radius: 0px; background-color: #ffffff;" bgcolor="#ffffff" background="https://curtainsandblinds.in/public/images/emails/image-1732469272892.png">
                <!--<![endif]-->
                <!--[if gte mso 9]>
            ...
            <![endif]-->
                ...
                <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
                    <v:fill src="images/image-1732469272892.png" color="#ffffff" type="frame" size="1,1" aspect="atleast" origin="0,0" position="0,0"/>
                    ...
                    <tr class="pc-grid-tr-first pc-grid-tr-last">
                     <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-30" align="left" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                      <table style="border-collapse: separate; border-spacing: 0; width: 100%;" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                       <tr>
                        <td class="pc-w620-padding-0-0-0-97" align="left" valign="top" style="padding: 24px 0px 0px 108px; mso-padding-left-alt: 0; margin-left:108px;">
                ...
                <!--[if gte mso 9]>
                                                ...
                                                <td width="47" style="line-height: 1px; font-size: 1px;" valign="top">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" height="36" style="line-height: 1px; font-size: 1px;">&nbsp;</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w620-padding-30-30-36-30" style="padding: 30px 60px 40px 60px; border-radius: 0px; background-color: #ffffff;" bgcolor="#ffffff">
                 ...
                 <tr>
                  <td valign="top" align="left">
                   <div class="pc-font-alt" style="line-height: 21px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                    <div><span>Dear {{ $data['name'] }}, <br/>
                    
                    Congratulations! on your first step towards a successful association. We acknowledge {{ $data['name'] }} as a confirmed Franchise with Curtains and Blinds, New Delhi, India. Your registration details are as follows:
                    <br/>Franchise Id: {{ $data['franchise_id'] }}<br/> 
                    Email-id {{ $data['email'] }} <br/> 
                    Password: {{ $data['password'] }} <br/> 
                    
                    <br/>Best regards, <br/>Curtains and Blinds <br/>support@curtainsandblinds.in</span>
                    </div>
                   </div>
                  </td>
                 </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 30px 60px 5px 60px; border-radius: 0px; background-color: #000000;" bgcolor="#000000">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                   ...
                   <table class="pc-width-fill pc-w620-gridCollapsed-0" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr class="pc-grid-tr-first pc-grid-tr-last">
                             ...
                             <tr>
                              <td valign="top">
                               <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="left" style="border-collapse: separate; border-spacing: 0;">
                                <tr>
                                 <td valign="top" align="left">
                                  <div class="pc-font-alt" style="line-height: 16px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 10px; font-weight: normal; font-variant-ligatures: normal; color: #ffffff; text-align: left; text-align-last: left;">
                                   <div><span style="color: rgb(255, 255, 255);letter-spacing: 0px;">7838357850</span>
                                   </div>
                                   <div><span style="color: rgb(255, 255, 255);letter-spacing: 0px;">support@curtainsandblinds.in</span>
                                   </div>
                                   <div><span style="color: rgb(255, 255, 255);letter-spacing: 0px;">info@curtainsandblinds.in</span>
                                   </div>
                                  </div>
                                 </td>
                                </tr>
                     ...
                     <td class="pc-grid-td-last pc-w620-itemsSpacings-0-20" align="left" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 20px;">
                      <table style="border-collapse: separate; border-spacing: 0; width: 100%;" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                       <tr>
                        <td class="pc-w620-halign-right pc-w620-valign-middle" align="right" valign="top">
                         <table class="pc-w620-halign-right" align="right" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                          <tr>
                           <td class="pc-w620-halign-right" align="right" valign="top">
                            <table class="pc-w620-halign-right" width="100%" align="right" border="0" cellpadding="0" cellspacing="0" role="presentation">
                             <tr>
                              <td valign="top">
                               <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="right" style="border-collapse: separate; border-spacing: 0;">
                                <tr>
                                 <td valign="top" class="pc-w620-textAlign-right" align="right">
                                  <div class="pc-font-alt pc-w620-textAlign-right" style="line-height: 30px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 13px; font-weight: normal; font-variant-ligatures: normal; color: #ffffff; text-align: right; text-align-last: right;">
                                   <div><span style="color: rgb(255, 255, 255);">Follow Us</span>
                                   </div>
                                  </div>
                                 </td>
                                </tr>
                          ...
                          <tr>
                           <td class="pc-w620-halign-right" align="right" valign="top">
                            <table class="pc-w620-halign-right" align="right" border="0" cellpadding="0" cellspacing="0" role="presentation">
                             <tr>
                              <td class="pc-w620-valign-middle pc-w620-align-right" align="left">
                               <table class="pc-w620-align-right" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                 <td valign="top">
                                  <table class="pc-width-hug pc-w620-gridCollapsed-0 pc-w620-halign-right" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                   <tr class="pc-grid-tr-first pc-grid-tr-last">
                                    <td class="pc-grid-td-first pc-w620-itemsSpacings-2-0" valign="middle" style="width: 25%; padding-top: 0px; padding-right: 1px; padding-bottom: 0px; padding-left: 0px;">
                                     <table style="border-collapse: separate; border-spacing: 0;" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                       <td class="pc-w620-halign-right pc-w620-valign-middle" align="left" valign="top">
                                        <table class="pc-w620-halign-right" align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                         <tr>
                                          <td class="pc-w620-halign-right" align="left" valign="top">
                                           <table class="pc-w620-halign-right" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                             <td valign="top">
                                              <img src="https://curtainsandblinds.in/public/images/emails/0bda7e9825d3b14f8123bd47abb0ec36.png" class="" width="12" height="12" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 12px; height: 12px;" alt="" />
                                             </td>
                                            </tr>
                                           </table>
                                          </td>
                                    ...
                                    <td class="pc-w620-itemsSpacings-2-0" valign="middle" style="width: 25%; padding-top: 0px; padding-right: 1px; padding-bottom: 0px; padding-left: 1px;">
                                     <table style="border-collapse: separate; border-spacing: 0;" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                       <td class="pc-w620-halign-right pc-w620-valign-middle" align="left" valign="top">
                                        <table class="pc-w620-halign-right" align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                         <tr>
                                          <td class="pc-w620-halign-right" align="left" valign="top">
                                           <table class="pc-w620-halign-right" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                             <td valign="top">
                                              <img src="https://curtainsandblinds.in/public/images/emails/a9bd5b3cdeed12d9f1bdeedc1e5b27bd.png" class="" width="12" height="12" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 12px; height: 12px;" alt="" />
                                             </td>
                                            </tr>
                                           </table>
                                          </td>
                                         ...
                                         <tr>
                                          <td class="pc-w620-halign-right" align="left" valign="top">
                                           <table class="pc-w620-halign-right" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                             <td valign="top">
                                              <img src="https://curtainsandblinds.in/public/images/emails/82c2727338d8c9104ae51f974013ee63.png" class="" width="12" height="12" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 12px; height: 12px;" alt="" />
                                             </td>
                                            </tr>
                                           </table>
                                          </td>
                                    ...
                                    <td class="pc-grid-td-last pc-w620-itemsSpacings-2-0" valign="middle" style="width: 25%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 1px;">
                                     <table style="border-collapse: separate; border-spacing: 0;" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                       <td class="pc-w620-halign-right pc-w620-valign-middle" align="left" valign="top">
                                        <table class="pc-w620-halign-right" align="left" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                         <tr>
                                          <td class="pc-w620-halign-right" align="left" valign="top">
                                           <table class="pc-w620-halign-right" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                             <td valign="top">
                                              <img src="https://curtainsandblinds.in/public/images/emails/a68bf3f6cfb7a897d500db91e12450e4.png" class="" width="12" height="12" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 12px; height: 12px;" alt="" />
                                             </td>
                                            </tr>
                                           </table>
                                          </td>

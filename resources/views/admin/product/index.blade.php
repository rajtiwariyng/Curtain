            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response && response.product) {
                        ...
                        $('#usage').text((product.usage || '-').replace(/[\[\]"]/g, ''));
$('#type').text((product.type || '-').replace(/[\[\]"]/g, ''));
$('#design-type').text((product.design_type || '-').replace(/[\[\]"]/g, ''));
$('#colour').text((product.colour || '-').replace(/[\[\]"]/g, ''));
$('#composition').text((product.composition || '-').replace(/[\[\]"]/g, ''));

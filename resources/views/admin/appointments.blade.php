        ...
        document.getElementById('updatepayment').addEventListener('submit', function(e) {
           ...
           //var payment_type = document.getElementById('paymenttype').value;
            ...
            fetch('/razorpay-order', {
                ...
                body: JSON.stringify({ order_id : orderId, order_value: orderValue, payment_mode: payment_mode ,remarks: payment_note,appointment_id : orderappointmentId ,franchise_id : orderfranchisetId,quotation_id : orderquotationId })
